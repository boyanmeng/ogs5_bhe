	...
	public:
		...
		*/
        BHE_CXC(const std::string name             /* name of the BHE */,
                ...
                : BHEAbstract(BHE::BHE_TYPE_CXA, name, bound_type, if_use_ext_Ra_Rb, my_bhe_cop_curve_idx)
		{
            ...
            CSA_o = PI * my_r_outer * my_r_outer - PI * r_inner * r_inner;
            CSA_g = 0.25 * PI * D * D - CSA_o - CSA_i;
